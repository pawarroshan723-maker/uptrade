...
(async () => {
  ...
  ok('F&O hint lives in the quick-head, not in the form body', !!w.document.querySelector('#orderTicket .quick-head #oDerivHint') && !w.document.querySelector('#orderTicket .order-form-v2 #oDerivHint'));
